...
class JoinForm(forms.Form):
	...
	firstname = forms.CharField(label="FIRSTNAME", max_length=30, widget=forms.TextInput(attrs={'class': 'form-control'}), required=False)
	lastname = forms.CharField(max_length=30, required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
...
class ProfileForm(forms.Form):
	email = forms.CharField(label="EMAIL", required=False, widget=forms.EmailInput(attrs={'class': 'form-control'}))
	firstname = forms.CharField(label="FIRSTNAME", max_length=30, required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
	lastname = forms.CharField(max_length=30, required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
	school = forms.CharField(max_length=30, required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
	major = forms.CharField(max_length=30, required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
	phone = forms.CharField(max_length=20, required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
